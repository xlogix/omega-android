...
public class HtmlFileActivity extends Activity implements OnClickListener {
  ...
  public static final String ACTION_ABOUT = "xyz.fnplus.omega.action.ABOUT";
  public static final String ACTION_USER_GUIDE = "xyz.fnplus.omega.action.USER_GUIDE";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    iconImageView = findViewById(R.id.holmes_icon_image);

...
public class AppTrackerWidgetProvider extends AppWidgetProvider {
  ...
  public static String ACTION_UPDATE_PAGE_FORWARD = "xyz.fnplus.omega.action.PAGE_UPDATE_FORWARD";
  public static String ACTION_UPDATE_PAGE_BACK = "xyz.fnplus.omega.action.PAGE_UPDATE_BACK";
  public static String ACTION_RESTART_SERVICE = "xyz.fnplus.omega.action.RESTART_SERVICE";
  ...
  @Override public void onReceive(Context context, Intent intent) {
    ...
    if (ACTION_UPDATE_PAGE_FORWARD.equals(intent.getAction()) || ACTION_UPDATE_PAGE_BACK.equals(
        intent.getAction())) {
      ...
      log.d("moving to new page for appWidgetId %d; pageNumber is now %d", appWidgetId,
          newPageNumber);
  ...
  private void updateActivityLog(Context context, String packageName) {
    ...
    log.d("componentName is '%s' / '%s'", componentName.getPackageName(),
    ...
    synchronized (AppHistoryDbHelper.class) {
      ...
      dbHelper.addEmptyPackageAndProcessIfNotExists(componentName.getPackageName(),
          componentName.getShortClassName());
    }

...
public class LoadedAppHistoryAdapter extends ArrayAdapter<LoadedAppHistoryEntry> {
  ...
  public LoadedAppHistoryAdapter(Context context, int resourceId, List<LoadedAppHistoryEntry> items,
      SortType sortType, boolean excludeAppsMode) {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      wrapper.enabledCheckBox =
          (CheckBox) convertView.findViewById(R.id.app_history_list_check_box);
    ...
    wrapper.description.setText(
        SubtextHelper.createSubtext(context, sortType, entry.getAppHistoryEntry(), true));

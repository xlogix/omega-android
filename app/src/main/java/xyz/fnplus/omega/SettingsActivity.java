...
public class SettingsActivity extends PreferenceActivity
  ...
  private void initializePreferences() {
    ...
    decayConstantPreference =
        (EditTextPreference) findPreference(R.string.time_decay_constant_preference);
    decayConstantPreference.setText(
        Integer.toString(PreferenceHelper.getDecayConstantPreference(getApplicationContext())));
    ...
    enableIconCachingPreference =
        (CheckBoxPreference) findPreference(R.string.enable_icon_caching_preference);
    showNotificationPreference =
        (CheckBoxPreference) findPreference(R.string.show_notification_preference);

    for (Preference preference : new Preference[] {
        appsToExcludePreference, resetDataPreference, resetIntrosPreference
    }) {
      preference.setOnPreferenceClickListener(this);
    }

    for (Preference preference : new Preference[] {
        decayConstantPreference, enableIconCachingPreference, showNotificationPreference
    }) {
  ...
  @Override public boolean onPreferenceChange(Preference preference, Object newValue) {
    ...
    if (preference.getKey()
        .equals(getResources().getString(R.string.time_decay_constant_preference))) {
      ...
      try {
        ...
        Toast.makeText(getApplicationContext(), R.string.bad_decay_constant_toast,
            Toast.LENGTH_LONG).show();
        return false;
      }
    } else if (preference.getKey()
        .equals(getResources().getString(R.string.show_notification_preference))) {
  ...
  @Override public boolean onPreferenceClick(Preference preference) {
    ...
    if (preference.getKey().equals(getResources().getString(R.string.apps_to_exclude_preference))) {
      ...
      startActivity(excludeIntent);
        ...
        .equals(getResources().getString(R.string.reset_intros_preference))) {// reset introduction

      PreferenceHelper.setFirstRunPreference(getApplicationContext(), true);
      Toast.makeText(getApplicationContext(), R.string.reset_intros_message, Toast.LENGTH_SHORT)
          .show();
      ...
      @Override public void onClick(DialogInterface dialog, int which) {
        ...
        builder.setPositiveButton(android.R.string.ok, new OnClickListener() {
          ...
          @Override public void onClick(DialogInterface dialog, int which) {
            ...
            Toast.makeText(getApplicationContext(), R.string.data_deleted, Toast.LENGTH_LONG)
                .show();
          }
        });

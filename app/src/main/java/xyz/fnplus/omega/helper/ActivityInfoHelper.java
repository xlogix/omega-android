...
public class ActivityInfoHelper {
  ...
  public static String loadLabelFromAppHistoryEntry(Context context,
   ...
   */
  public static List<Pair<AppHistoryEntry, ActivityInfo>> getActivityInfos(Context context,
      AppHistoryDbHelper dbHelper, PackageManager packageManager, int pageNumber, int limit,
      SortType sortType, boolean showExcludedApps) {
    ...
    List<Pair<AppHistoryEntry, ActivityInfo>> activityInfos =
        new ArrayList<Pair<AppHistoryEntry, ActivityInfo>>();
    ...
    while (true) {
      ...
      synchronized (AppHistoryDbHelper.class) {
        appHistories = dbHelper.findInstalledAppHistoryEntries(sortType, limit, pageNumber * limit,
            showExcludedApps);
      }
  ...
  private static void loadLabelsInAdvance(Context context, AppHistoryDbHelper dbHelper,
  ...
  private static ActivityInfo getActivityInfo(PackageManager packageManager,

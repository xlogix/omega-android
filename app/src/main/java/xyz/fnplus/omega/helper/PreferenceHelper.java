...
public class PreferenceHelper {
  ...
  public static int getDecayConstantPreference(Context context) {
    ...
    int result =
        prefs.getInt(context.getResources().getString(R.string.time_decay_constant_preference),
  ...
  public static void setDecayConstantPreference(Context context, int decayConstant) {
    ...
    editor.putInt(context.getResources().getString(R.string.time_decay_constant_preference),
        decayConstant);
    editor.commit();
  }
  ...
  public static boolean getEnableIconCachingPreference(Context context) {
    ...
    boolean result =
        prefs.getBoolean(context.getResources().getString(R.string.enable_icon_caching_preference),
            true);
  ...
  public static void setEnableIconCachingPreference(Context context, boolean bool) {
    SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(context).edit();
    editor.putBoolean(context.getResources().getString(R.string.enable_icon_caching_preference),
        bool);
    editor.commit();
  }
  ...
  public static boolean getShowNotificationPreference(Context context) {
    ...
    boolean result =
        prefs.getBoolean(context.getResources().getString(R.string.show_notification_preference),
            true);
  ...
  public static void setShowNotificationPreference(Context context, boolean bool) {
    SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(context).edit();
    editor.putBoolean(context.getResources().getString(R.string.show_notification_preference),
        bool);
    editor.commit();
  }
  ...
  public static boolean getFirstRunPreference(Context context) {
    ...
    boolean result =
        prefs.getBoolean(context.getResources().getString(R.string.first_run_preference), true);
